...
static constexpr auto qt_meta_stringdata_ZN13DetailsDialogE = QtMocHelpers::stringData(
    "DetailsDialog",
    "on_okButton_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13DetailsDialogE[] = {
...
Q_CONSTINIT const QMetaObject DetailsDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13DetailsDialogE.offsetsAndSizes,
    qt_meta_data_ZN13DetailsDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13DetailsDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *DetailsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13DetailsDialogE.stringdata0))
